...
class fonctionCSV:
    ...
    def extraction(self, NomFichier, tk, cadre_contenu):
        ...
        for index, row in df.iterrows():
            ...
            tk.Label(self.frame_contenu, text=leTexte, relief="solid", background="lightblue").grid(row=index+1, column=0, padx=1, pady=3, sticky="nsew")
        ...
        for index, row in df.iterrows():
            ...
            tk.Label(self.frame_contenu, text=leTexteRobuste, relief="solid", background="lightgreen").grid(row=index+1, column=1, padx=1, pady=3, sticky="nsew")
        ...
        tk.Button(self.frame_contenu, text=f"Envoyer MDP", command=lambda ligne=ligne_df: self.load_data_thread(df, tk,"MotDePasse",'"mdp", "idSite", "categorie", "nbCaractere", "nbNum", "nbCarSpe", "idUtilisateur", "Robustesse", "carMini", "carMaj"')).grid(row=0, column=1, padx=1, pady=3, sticky="nsew")
