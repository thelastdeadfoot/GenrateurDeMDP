...
#   la taille du mot de passe 
    def __init__(self,nb_caratere_maj,nb_caratere_min,nb_numero,nb_caratere_special,professionel,mot_de_passe=None):
...
motdepasse = Motdepasse(0,0,0,0,1,"Alpha ariva")
